...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("😠 𝐇𝐞𝐲 𝐁𝐚𝐬𝐭𝐚𝐫𝐝,𝐖𝐓𝐅 𝐀𝐫𝐞 𝐘𝐨𝐮 𝐃𝐨𝐢𝐧𝐠,𝐏𝐥𝐞𝐚𝐬𝐞 𝐒𝐞𝐚𝐫𝐜𝐡 𝐘𝐨𝐮𝐫𝐬𝐞𝐥𝐟.", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
